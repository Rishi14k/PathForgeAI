...
const Sidebar = ({ collapsed, onToggle, mobileOpen, onMobileClose }) => {
  ...
  return (
    <>
      <aside
        className="hidden lg:flex flex-col flex-shrink-0 h-screen sticky top-0 z-30 transition-all duration-300 ease-in-out"
        style={{
          width: sidebarWidth,
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto overflow-x-hidden">
          {!collapsed && (
            <p
              className="text-xs font-600 uppercase tracking-widest mb-3 px-3"
